...
export const getTypeText = (type: string) => {
  switch (type) {
    case 'STAKE': return { label: "مستحقات (راتب / من جيبه)", color: "text-emerald-600", bg: "bg-emerald-50", icon: ArrowUpCircle };
    ...
    case 'PAYOUT': return { label: "تصفية / تسليم الراتب", color: "text-rose-600", bg: "bg-rose-50", icon: ArrowDownCircle };
