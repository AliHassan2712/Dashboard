...
export async function getTransactionsData(
  ...
  try {
    ...
    // جلب البيانات من 5 جداول ضمن فترة التاريخ المحددة
    ...
    // 💡 حساب الإحصائيات (Summary) لكل الحركات في هذه الفترة (وليس للصفحة فقط)
    ...
    return { 
      ...
      allDataForExport: unified // نرسل النسخة الكاملة لزر التصدير للإكسل
    };
  } catch (_error) {
