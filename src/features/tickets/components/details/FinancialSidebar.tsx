...
export const FinancialSidebar = ({ 
  ...
  setDiscountPercentage, payments, advancePayment, onAddPayment 
    ...
    <div className="bg-white p-6 rounded-2xl border shadow-sm space-y-5 sticky top-6">
      ...
      <div className="pt-2 border-t space-y-4">
        ...
        <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
          ...
          {payments?.map((p) => (
            <div key={p.id} className="flex justify-between text-xs p-3 bg-emerald-50 text-emerald-700 rounded-xl border border-emerald-100">
