...
import { 
  Ticket as TicketIcon, Wallet, ClipboardList, Wrench, ArrowLeftRight,
  Activity, Banknote, TrendingDown, Store, TrendingUp, Clock, CheckCircle,
...
// 1. مكون بطاقة الإحصائيات (Reusable)
export const StatCard = ({ title, value, icon: Icon, color, bg, isCurrency = true }: any) => (
...
// 2. واجهة الفني (Worker View)
export const WorkerDashboard = ({ workerStats, userName }: { workerStats: any, userName: string }) => (
  <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-700 pb-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Link href={ROUTES.TRIALS} className="flex items-center justify-between p-6 bg-white border border-gray-100 rounded-3xl hover:border-indigo-600 transition-all group shadow-sm">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-gray-50 rounded-xl group-hover:bg-indigo-50 transition-colors">
