...
interface QuotationFormProps {
  quoteData: QuoteData;
  updateField: (field: keyof QuoteData, value: string) => void;
}

export const QuotationForm = ({ quoteData, updateField }: QuotationFormProps) => (
      ...
      {quoteData.imageUrl ? (
        ...
        <div className="text-center p-6 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
          <UploadButton 
            ...
            onClientUploadComplete={(res: { url: string }[]) => updateField('imageUrl', res[0].url)} // 👈 إزالة any من res
