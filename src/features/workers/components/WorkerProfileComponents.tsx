import { Phone, User, Wallet, Calendar, ArrowUpCircle, ArrowDownCircle } from "lucide-react";

// --- 1. مكون بطاقة تعريف العامل ---
export const WorkerProfileCard = ({ worker }: { worker: any }) => (
