        ...
        <table className="w-full text-right text-sm">
          ...
          <tbody className="divide-y divide-gray-50 font-bold">
            {transactions.length === 0 ? (
              <tr><td colSpan={4} className="p-10 text-center text-gray-400 font-medium">لا توجد حركات مالية مسجلة.</td></tr>
            ) : (
              transactions.map((tx) => {
                ...
                return (
                  <tr key={tx.id} className="hover:bg-gray-50/50 transition-colors">
                    <td className="p-4 text-gray-400 flex items-center gap-2 whitespace-nowrap">
